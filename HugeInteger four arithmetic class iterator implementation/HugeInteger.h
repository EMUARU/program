...
HugeInteger< T > HugeInteger< T >::operator-( HugeInteger< T > &op2 )
{
   ...
   for (it1 = difference.integer.begin(); it2 != op2.integer.end(); ++it2, ++it1)
       *it1 -= *it2;

   for (it1 = difference.integer.begin(); it1 != --difference.integer.end();)
       if (*it1 < 10)
       {
           (*it1) += 10;
           (*(++it1))--;
   ...
   for (it1--; *it1 == 0 && it1 != difference.integer.begin(); difference.integer.pop_back())
       --it1;
...
HugeInteger< T > HugeInteger< T >::operator*( HugeInteger< T > &op2 )
{
   ...
   for (int i(0); i < op2.integer.size(); ++it2, ++i, it1 = integer.begin())
       for (int j(0); j < integer.size(); ++it1, ++j)
       {
           it3 = product.integer.begin();
           for (int k(0); k < i + j; ++it3, ++k);
           (it4 = it3)++;
           *it3 += *it1 * *it2;
           if (*it3 >= 10)
           {
   ...
   for (++it3; *it3 == 0 && product.integer.size() > 1; product.integer.pop_back())
       --it3;
...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger< T > &op2 )
{
   ...
   HugeInteger ten(2);
   typename T::iterator it1 = ten.integer.begin();
   ...
   *(++it1) = 1;
   ...
   typename T::iterator it2 = quotient.integer.begin();

   for (int i(0); i < quotientSize; i++, ++it2);
